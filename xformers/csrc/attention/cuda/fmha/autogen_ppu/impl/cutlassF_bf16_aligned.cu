...
fmha_cutlassF_bf16_aligned_k32x128x64_sm80(typename AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 32, 128, 64, 32, 64, false, true>::Params p) {
  ...
  AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 32, 128, 64, 32, 64, false, true>::attention_kernel(p);
  return;
#elif __CUDA_ARCH__ == 890
  return;
#else
  printf(
        "FATAL: kernel `fmha_cutlassF_bf16_aligned_k32x128x64_sm80` is for sm80/sm89, but was built for sm%d\n",
...
fmha_cutlassF_bf16_aligned_k48x128x32_sm80(typename AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 48, 128, 32, 32, 32, false, true>::Params p) {
  ...
  AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 48, 128, 32, 32, 32, false, true>::attention_kernel(p);
  return;
#elif __CUDA_ARCH__ == 890
  return;
#else
  printf(
        "FATAL: kernel `fmha_cutlassF_bf16_aligned_k48x128x32_sm80` is for sm80/sm89, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
#endif  // __CUDA_ARCH__
}
...
fmha_cutlassF_bf16_aligned_k64x128x64_sm80(typename AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 64, 128, 64, 32, 64, false, true>::Params p) {
  ...
  AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 64, 128, 64, 32, 64, false, true>::attention_kernel(p);
  return;
#elif __CUDA_ARCH__ == 890
  return;
#else
  printf(
        "FATAL: kernel `fmha_cutlassF_bf16_aligned_k64x128x64_sm80` is for sm80/sm89, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
#endif  // __CUDA_ARCH__
}
...
fmha_cutlassF_bf16_aligned_k80x128x64_sm80(typename AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 80, 128, 64, 32, 64, false, true>::Params p) {
  ...
  AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 80, 128, 64, 32, 64, false, true>::attention_kernel(p);
  return;
#elif __CUDA_ARCH__ == 890
  return;
#else
  printf(
        "FATAL: kernel `fmha_cutlassF_bf16_aligned_k80x128x64_sm80` is for sm80/sm89, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
#endif  // __CUDA_ARCH__
}
...
fmha_cutlassF_bf16_aligned_k96x128x64_sm80(typename AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 96, 128, 64, 32, 32, false, true>::Params p) {
  ...
  AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 96, 128, 64, 32, 32, false, true>::attention_kernel(p);
  return;
#elif __CUDA_ARCH__ == 890
  return;
#else
  printf(
        "FATAL: kernel `fmha_cutlassF_bf16_aligned_k96x128x64_sm80` is for sm80/sm89, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
#endif  // __CUDA_ARCH__
}
...
fmha_cutlassF_bf16_aligned_k128x128x64_sm80(typename AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 128, 128, 64, 32, 64, false, true>::Params p) {
  ...
  AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 128, 128, 64, 32, 64, false, true>::attention_kernel(p);
  return;
#elif __CUDA_ARCH__ == 890
  return;
#else
  printf(
        "FATAL: kernel `fmha_cutlassF_bf16_aligned_k128x128x64_sm80` is for sm80/sm89, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
#endif  // __CUDA_ARCH__
}
...
fmha_cutlassF_bf16_aligned_k160x256x128_sm80(typename AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 160, 256, 128, 32, 64, false, true>::Params p) {
  ...
  AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 160, 256, 128, 32, 64, false, true>::attention_kernel(p);
  return;
#elif __CUDA_ARCH__ == 890
  return;
#else
  printf(
        "FATAL: kernel `fmha_cutlassF_bf16_aligned_k160x256x128_sm80` is for sm80/sm89, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
#endif  // __CUDA_ARCH__
}
...
fmha_cutlassF_bf16_aligned_k256x256x32_sm80(typename AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 256, 256, 32, 32, 32, false, true>::Params p) {
  ...
  AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 256, 256, 32, 32, 32, false, true>::attention_kernel(p);
  return;
#elif __CUDA_ARCH__ == 890
  return;
#else
  printf(
        "FATAL: kernel `fmha_cutlassF_bf16_aligned_k256x256x32_sm80` is for sm80/sm89, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
#endif  // __CUDA_ARCH__
}
...
fmha_cutlassF_bf16_aligned_k32x128x64_dropout_sm80(typename AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 32, 128, 64, 32, 64, true, true>::Params p) {
  ...
  AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 32, 128, 64, 32, 64, true, true>::attention_kernel(p);
  return;
#elif __CUDA_ARCH__ == 890
  return;
#else
  printf(
        "FATAL: kernel `fmha_cutlassF_bf16_aligned_k32x128x64_dropout_sm80` is for sm80/sm89, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
#endif  // __CUDA_ARCH__
}
...
fmha_cutlassF_bf16_aligned_k48x128x32_dropout_sm80(typename AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 48, 128, 32, 32, 32, true, true>::Params p) {
  ...
  AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 48, 128, 32, 32, 32, true, true>::attention_kernel(p);
  return;
#elif __CUDA_ARCH__ == 890
  return;
#else
  printf(
        "FATAL: kernel `fmha_cutlassF_bf16_aligned_k48x128x32_dropout_sm80` is for sm80/sm89, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
#endif  // __CUDA_ARCH__
}
...
fmha_cutlassF_bf16_aligned_k64x128x64_dropout_sm80(typename AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 64, 128, 64, 32, 64, true, true>::Params p) {
  ...
  AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 64, 128, 64, 32, 64, true, true>::attention_kernel(p);
  return;
#elif __CUDA_ARCH__ == 890
  return;
#else
  printf(
        "FATAL: kernel `fmha_cutlassF_bf16_aligned_k64x128x64_dropout_sm80` is for sm80/sm89, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
#endif  // __CUDA_ARCH__
}
...
fmha_cutlassF_bf16_aligned_k80x128x64_dropout_sm80(typename AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 80, 128, 64, 32, 64, true, true>::Params p) {
  ...
  AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 80, 128, 64, 32, 64, true, true>::attention_kernel(p);
  return;
#elif __CUDA_ARCH__ == 890
  return;
#else
  printf(
        "FATAL: kernel `fmha_cutlassF_bf16_aligned_k80x128x64_dropout_sm80` is for sm80/sm89, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
#endif  // __CUDA_ARCH__
}
...
fmha_cutlassF_bf16_aligned_k96x128x64_dropout_sm80(typename AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 96, 128, 64, 32, 32, true, true>::Params p) {
  ...
  AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 96, 128, 64, 32, 32, true, true>::attention_kernel(p);
  return;
#elif __CUDA_ARCH__ == 890
  return;
#else
  printf(
        "FATAL: kernel `fmha_cutlassF_bf16_aligned_k96x128x64_dropout_sm80` is for sm80/sm89, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
#endif  // __CUDA_ARCH__
}
...
fmha_cutlassF_bf16_aligned_k128x128x64_dropout_sm80(typename AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 128, 128, 64, 32, 64, true, true>::Params p) {
  ...
  AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 128, 128, 64, 32, 64, true, true>::attention_kernel(p);
  return;
#elif __CUDA_ARCH__ == 890
  return;
#else
  printf(
        "FATAL: kernel `fmha_cutlassF_bf16_aligned_k128x128x64_dropout_sm80` is for sm80/sm89, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
#endif  // __CUDA_ARCH__
}
...
fmha_cutlassF_bf16_aligned_k160x256x128_dropout_sm80(typename AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 160, 256, 128, 32, 64, true, true>::Params p) {
  ...
  AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 160, 256, 128, 32, 64, true, true>::attention_kernel(p);
  return;
#elif __CUDA_ARCH__ == 890
  return;
#else
  printf(
        "FATAL: kernel `fmha_cutlassF_bf16_aligned_k160x256x128_dropout_sm80` is for sm80/sm89, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
#endif  // __CUDA_ARCH__
}
...
fmha_cutlassF_bf16_aligned_k256x256x32_dropout_sm80(typename AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 256, 256, 32, 32, 32, true, true>::Params p) {
  ...
  AttentionKernelFA2<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 256, 256, 32, 32, 32, true, true>::attention_kernel(p);
  return;
#elif __CUDA_ARCH__ == 890
  return;
#else
  printf(
        "FATAL: kernel `fmha_cutlassF_bf16_aligned_k256x256x32_dropout_sm80` is for sm80/sm89, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
#endif  // __CUDA_ARCH__
}
...
fmha_cutlassF_bf16_aligned_64x64_k64_rf_sm80(typename AttentionKernel<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 64, 64, true, true, true, 64>::Params p) {
  ...
  AttentionKernel<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 64, 64, true, true, true, 64>::attention_kernel(p);
  return;
#elif __CUDA_ARCH__ == 890
  return;
#else
  printf(
        "FATAL: kernel `fmha_cutlassF_bf16_aligned_64x64_k64_rf_sm80` is for sm80/sm89, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
#endif  // __CUDA_ARCH__
}
...
fmha_cutlassF_bf16_aligned_32x128_k128_rf_sm80(typename AttentionKernel<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 32, 128, true, true, true, 128>::Params p) {
  ...
  AttentionKernel<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 32, 128, true, true, true, 128>::attention_kernel(p);
  return;
#elif __CUDA_ARCH__ == 890
  return;
#else
  printf(
        "FATAL: kernel `fmha_cutlassF_bf16_aligned_32x128_k128_rf_sm80` is for sm80/sm89, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
#endif  // __CUDA_ARCH__
}
...
fmha_cutlassF_bf16_aligned_32x128_k65536_gmem_sm80(typename AttentionKernel<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 32, 128, false, true, true, 65536>::Params p) {
  ...
  AttentionKernel<cutlass::bfloat16_t, cutlass::arch::Sm80, true, 32, 128, false, true, true, 65536>::attention_kernel(p);
  return;
#elif __CUDA_ARCH__ == 890
  return;
#else
  printf(
        "FATAL: kernel `fmha_cutlassF_bf16_aligned_32x128_k65536_gmem_sm80` is for sm80/sm89, but was built for sm%d\n",
        int(__CUDA_ARCH__ + 0) / 10);
#endif
#endif  // __CUDA_ARCH__
}
