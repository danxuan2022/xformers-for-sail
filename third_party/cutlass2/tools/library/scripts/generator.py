...
def GenerateSM80_TensorOp_16816(manifest, args):
  ...
  for math_inst in math_instructions:
    ...
    if args.device == "ppu":
      tile_descriptions = [
        TileDescription([512, 128, 32],  3, [8, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([128, 512, 32],  3, [2, 8, 1], math_inst, min_cc, max_cc),
        TileDescription([512,  64, 32],  3, [8, 1, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64, 512, 32],  3, [1, 8, 1], math_inst, min_cc, max_cc),
        TileDescription([512,  64, 32],  4, [8, 1, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64, 512, 32],  4, [1, 8, 1], math_inst, min_cc, max_cc),
        TileDescription([256, 128, 32],  3, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([128, 256, 32],  3, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([256, 128, 32],  4, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([128, 256, 32],  4, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([256, 128, 32],  3, [4, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128, 256, 32],  3, [4, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([256, 128, 32],  4, [4, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128, 256, 32],  4, [4, 4, 1], math_inst, min_cc, max_cc),
        ...
        TileDescription([256,  64, 64],  3, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64, 256, 64],  3, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([256,  64, 64],  3, [4, 1, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64, 256, 64],  3, [1, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128, 128, 32],  3, [2, 4, 1], math_inst, min_cc, max_cc),
        ...
        TileDescription([128, 128, 64],  3, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([128,  64, 32],  3, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64, 128, 32],  3, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128,  64, 64],  3, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64, 128, 64],  3, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128,  64, 32],  4, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64, 128, 32],  4, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128,  64, 64],  4, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64, 128, 64],  4, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128,  32, 32],  3, [4, 1, 1], math_inst, min_cc, max_cc),
        TileDescription([ 32, 128, 32],  3, [1, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128,  32, 32],  3, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 32, 128, 32],  3, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128,  32, 64],  3, [4, 1, 1], math_inst, min_cc, max_cc),
        TileDescription([ 32, 128, 64],  3, [1, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128,  32, 64],  3, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 32, 128, 64],  3, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128,  32, 32],  4, [4, 1, 1], math_inst, min_cc, max_cc),
        TileDescription([ 32, 128, 32],  4, [1, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128,  32, 32],  4, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 32, 128, 32],  4, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128,  32, 64],  4, [4, 1, 1], math_inst, min_cc, max_cc),
        TileDescription([ 32, 128, 64],  4, [1, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128,  32, 64],  4, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 32, 128, 64],  4, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 32],  3, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 32],  3, [2, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 32],  3, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 64],  3, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 64],  3, [2, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 64],  3, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 32],  4, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 32],  4, [2, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 32],  4, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 64],  4, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 64],  4, [2, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 64],  4, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  32, 32],  4, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 32,  64, 32],  4, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  32, 32],  4, [2, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 32,  64, 32],  4, [2, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  32, 64],  4, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 32,  64, 64],  4, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  32, 64],  4, [2, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 32,  64, 64],  4, [2, 2, 1], math_inst, min_cc, max_cc),
      ]
    else:
      tile_descriptions = [
        TileDescription([256, 128, 32],  3, [4, 2, 1], math_inst, min_cc, max_cc),
...
def GenerateSM80_TensorOp_1688(manifest, args):
  ...
  for math_inst in math_instructions:
    if args.device == "ppu":
      tile_descriptions = [
        TileDescription([512, 128, 16],  3, [8, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([128, 512, 16],  3, [2, 8, 1], math_inst, min_cc, max_cc),
        TileDescription([512,  64, 16],  3, [8, 1, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64, 512, 16],  3, [1, 8, 1], math_inst, min_cc, max_cc),
        TileDescription([512,  64, 16],  4, [8, 1, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64, 512, 16],  4, [1, 8, 1], math_inst, min_cc, max_cc),
        TileDescription([256, 128, 16],  3, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([128, 256, 16],  3, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([256, 128, 16],  4, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([128, 256, 16],  4, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([256, 128, 16],  3, [4, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128, 256, 16],  3, [4, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([256, 128, 16],  4, [4, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128, 256, 16],  4, [4, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([256,  64, 16],  3, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64, 256, 16],  3, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([256,  64, 16],  3, [4, 1, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64, 256, 16],  3, [1, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([256,  64, 32],  3, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64, 256, 32],  3, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([256,  64, 32],  3, [4, 1, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64, 256, 32],  3, [1, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128, 128, 16],  3, [2, 4, 1], math_inst, min_cc, max_cc),
        ...
        TileDescription([128,  64, 32],  4, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64, 128, 32],  4, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128,  32, 16],  3, [4, 1, 1], math_inst, min_cc, max_cc),
        TileDescription([ 32, 128, 16],  3, [1, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128,  32, 16],  3, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 32, 128, 16],  3, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128,  32, 32],  3, [4, 1, 1], math_inst, min_cc, max_cc),
        TileDescription([ 32, 128, 32],  3, [1, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128,  32, 32],  3, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 32, 128, 32],  3, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128,  32, 16],  4, [4, 1, 1], math_inst, min_cc, max_cc),
        TileDescription([ 32, 128, 16],  4, [1, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128,  32, 16],  4, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 32, 128, 16],  4, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128,  32, 32],  4, [4, 1, 1], math_inst, min_cc, max_cc),
        TileDescription([ 32, 128, 32],  4, [1, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128,  32, 32],  4, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 32, 128, 32],  4, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 16],  3, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 16],  3, [2, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 16],  3, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 32],  3, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 32],  3, [2, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 32],  3, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 16],  4, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 16],  4, [2, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 16],  4, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 32],  4, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 32],  4, [2, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, 32],  4, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  32, 16],  4, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 32,  64, 16],  4, [2, 4, 1], math_inst, min_cc, max_cc),
...
#
def GenerateSM80_Conv2d(manifest, args):
  ...
  for math_inst in math_instructions:
    tile_descriptions = []
    tilek = [32, 64] if math_inst.element_a == DataType.f16 else [32]
    for tk in tilek:
      tile_descriptions.extend([
        TileDescription([256, 128, tk],  3, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([256, 128, tk],  3, [4, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([256,  64, tk],  3, [4, 1, 1], math_inst, min_cc, max_cc),
        TileDescription([256,  64, tk],  3, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([128, 256, tk],  3, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128, 256, tk],  3, [4, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128, 128, tk],  3, [2, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([128, 128, tk],  3, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128, 128, tk],  3, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([128, 128, tk],  3, [4, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([128,  64, tk],  3, [2, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([128,  64, tk],  3, [4, 1, 1], math_inst, min_cc, max_cc),
        TileDescription([128,  64, tk],  3, [4, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64, 128, tk],  3, [2, 2, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64, 128, tk],  3, [1, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64, 128, tk],  3, [2, 4, 1], math_inst, min_cc, max_cc),
        TileDescription([ 64,  64, tk],  3, [2, 2, 1], math_inst, min_cc, max_cc),
      ])
...
if __name__ == "__main__":
  ...
  parser.add_argument('--device',   type=str, default="gpu", required=False, help='build gpu or ppu kernel')
  ...
  #GenerateSM80_Conv2d(manifest, args)
