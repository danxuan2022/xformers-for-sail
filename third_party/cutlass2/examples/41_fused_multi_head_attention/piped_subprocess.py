...
class PipedSubprocess:
    ...
    def __enter__(self) -> "PipedSubprocess":
        self.subp = subprocess.Popen(self.binary, stdin=subprocess.PIPE, shell=True, stderr=subprocess.PIPE, text=True, bufsize=0)
        # self.subp = subprocess.Popen(self.binary, stdin=subprocess.PIPE, shell=True, text=True)
